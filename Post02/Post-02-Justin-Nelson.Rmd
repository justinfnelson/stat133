---
title: "Bringing Geographical Data to Life: Usage of maps"
...
```
With the tables now joined, we can generate the map. We'll make maps that display funding in each state, percentage of students who take the SAT in each state, and performance on the SAT in each state.
